    ...
    <div class="register-form">
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <input id="name" type="text" name="name" value="{{ old('name') }}" placeholder="Jožko Mrkvička" required
                    autofocus />
            ...
            <div>
                ...
                <input id="email" type="email" name="email" value="{{ old('email') }}" placeholder="e-mail@gmail.com"
                    required />
            ...
            <div>
                ...
                <input id="password_confirmation" type="password" name="password_confirmation" placeholder="heslo"
                    required />
