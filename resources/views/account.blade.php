...
@section('obsah')
    ...
    <div class="container-account">
        ...
        <div class="item-75" id="credentials-disabled">
            ...
            <p>
                <input id="male" type="radio" value="MALE" name="sex-dis" {{ Auth::user()->sex == 'MALE' ? 'checked' : '' }}
                    disabled>
    ...
    <div class="container-account">
        ...
        <div class="item-75" id="address-disabled">
            <p>
                <input id="street" type="text" placeholder="Národná 1" value="{{ Auth::user() ? Auth::user()->street : 'NA' }}" disabled>
                <label for="street"></label>
            </p>
            <p>
                <input id="city" type="text" placeholder="Bratislava" value="{{ Auth::user() ? Auth::user()->city : 'NA' }}" disabled>
                <label for="city"></label>
            </p>
            <p>
                <input id="county" type="text" placeholder="Bratislavský" value="{{ Auth::user() ? Auth::user()->county : 'NA' }}" disabled>
                <label for="county"></label>
            </p>
            <p>
                <input id="psc" type="text" placeholder="01001" value="{{ Auth::user() ? Auth::user()->psc : 'NA' }}" disabled>
                <label for="psc"></label>
            </p>
            <p>
                <input id="state" type="text" placeholder="Slovensko" value="{{ Auth::user() ? Auth::user()->state : 'NA' }}" disabled>
